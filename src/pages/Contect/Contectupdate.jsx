...
import { Getcontact, Updatecontact } from "../../Redux/Actioncreator/Contactusactioncreator"
import { useDispatch } from 'react-redux'
import { useSelector } from 'react-redux'

export default function Contactusupdate() {
    ...
    async function postinputdata(e) {
        ...
        if (error) {
            ...
            let item = contactusStatedata.find(x => x.id !== id && x.state.toLowerCase() === data.state.toLowerCase())
            if (item) {
                setshow(true)
                seterrormassege((old) => {
                    return {
